...
<body class="fix-header fix-sidebar">
    ...
    <script src="<?=base_url()?>vendor/form-validation/jquery.validate.unobtrusive.min.js"></script>
    <script src="<?=base_url()?>vendor/jquery.nicescroll/jquery.nicescroll.min.js"></script>
