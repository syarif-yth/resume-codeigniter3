	...
	<div class="col-lg-5">
		<div class="card">
			...
			<div class="card-body info-body">
				...
				<button onclick="history.back(1)" type="button" class="btn btn-secondary btn-custom btn-block">Back</button>
			</div>
		</div>
	</div>
					...
					<div class="form-group row m-b-7 p-r-20">
						...
						<div class="col-sm-8 p-0 p-t-10">
							<div class="checkbox checkbox-success">
								...
								<label for="masih_bekerja">This is my role at this point</label>
							</div>
						</div>
					</div>
					...
					<div class="form-group row m-b-7 p-r-20">
						...
						<div class="col-sm-8 p-0 p-t-10">
							<div class="checkbox checkbox-success">
								...
								<label for="masih_sekolah">This is my role at this point</label>
							</div>
						</div>
					</div>
